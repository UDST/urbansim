...
def get_development_projects():
    ...
    scheduled_development_events = scheduled_development_events[['scheduled_development_event_id', 'year_built', 'development_type_id', 'stories', 'non_residential_sqft', 'sqft_per_unit', 'residential_units', 'parcel_id']]
